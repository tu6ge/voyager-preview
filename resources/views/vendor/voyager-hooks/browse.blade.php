...
@section('page_header')
    <h1 class="page-title">
        ...
        <div class="btn btn-success  " data-toggle="popover" data-container="body" data-content="演示版不可设置"
                            ...
                            @foreach($hooks as $hook)
                                <tr>
                                    ...
                                    <td class="no-sort no-click">
                                        <div class="btn-sm btn-danger pull-right " data-id="{{ $hook->name }}" id="delete-{{ $hook->name }}"
                                            data-toggle="popover" data-container="body" data-content="演示版不可设置"
        data-placement="bottom"
                                            >
